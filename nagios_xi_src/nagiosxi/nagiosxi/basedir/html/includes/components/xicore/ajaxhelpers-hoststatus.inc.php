    ...
    if (!empty($xml)) {
        foreach ($xml->hoststatus as $x) {
            ...
            if (!empty($display_host_name)) {
                ...
                $host_name_cell .= "<div class='flex justify-between items-center'><div class='hostname'><a href='" . $detail_url . "' title='" . $address . "'>" . $show_host_name . "</a></div>";
            ...
            if(is_neptune()){
                ...
                <td  nowrap><span class='status-dot " . $host_status_class . " dot-10'></span>" . $status_cell . "</td>
                ...
                <td class='mono mono-text'><div class='scrollable-30'>" . $status_info . "</div></td>";
            } else {
                $output .= "<tr class='" . $rowclass . "'>
...
function xicore_ajax_get_host_status_state_summary_html($args = null)
{
    ...
    if ($xml == null) {
        ...
        $img = "fa fa-question-circle fa-xl fa-unknown";
        $imgalt = _("Unknown");
        ...
        switch ($current_state) {
            ...
            case 1:
                if(is_neptune()) {
                    $img = "../../../images/status-circle-down.svg";
                    if(get_theme() == 'neptunelight') {
                        $img = "../../../images/status-circle-down-light.svg";
                    }
                } else {
            ...
            case 2:
                if(is_neptune()) {
                    ...
                    if(get_theme() == 'neptunelight') {
                        $img = "../../../images/status-circle-unreachable-light.svg";
                    }
                } else {
                    $img = "fa fa-question-circle fa-xl fa-unknown";
                }
        ...
        if(is_neptune()) {
            ...
            $output .= '<div class="neptune-status-well well"><div class="hoststatusdetailinfo summary-status">';
            $imgwidth = "24";        
