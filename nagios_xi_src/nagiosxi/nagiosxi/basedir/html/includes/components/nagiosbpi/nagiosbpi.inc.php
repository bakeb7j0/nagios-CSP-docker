...
<table class="table table-condensed table-no-border table-auto-width">
    ...
    <tr>
        ...
        <td>
            <div class="input-group">
                ...
                <label class="input-group-addon">' . _('backups') . '</label>
            </div>
        ...
        <td>
            <div class="checkbox">
                <label>
                    ...
                    <div>' . _('Ignore host and service problems that are acknowledged or in scheduled downtime.') . ' ' . _("Handled problems will not be factored into the group's problem percentage.") . '</div>
                </ label>
            </div>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <div class="checkbox neptune-nagbpi-checkbox">
...
function bpi_component_remove_member($group, $host, $service='NULL')
{
    ...
    $vars = [];
    $config_string = process_post($arr, false, $vars);
    if ($config_string) {
