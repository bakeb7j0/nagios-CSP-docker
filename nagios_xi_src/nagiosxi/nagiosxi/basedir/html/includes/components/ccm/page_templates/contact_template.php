...
?>
    <div id="tab1">
        <div class="leftBox">
            <div class="ccm-row">
                <label for="tfName"><?php echo ccm_get_full_title($this->exactType); ?> <?php echo _("Username"); ?> <span class="req">*</span></label>
            ...
            <div class="ccm-row">
                ...
                <input name="tfFriendly" class='form-control fc-fl' type="text" id="tfFriendly" value="<?php (!empty($FIELDS['alias'])) ? val(encode_form_val($FIELDS['alias'])) : ""; ?>">
            </div>
            <div class="ccm-row">
                <label for="tfEmail"><?php echo _("Email Address"); ?></label>
                <input type="text" value="<?php (!empty($FIELDS['email'])) ? val(encode_form_val($FIELDS['email'])) : ""; ?>" class='form-control fc-fl' id="tfEmail" name="tfEmail">
            </div>
            <div class="ccm-row spacer">
                <label for="tfPager"><?php echo _("Pager Number"); ?></label>
                <input type="text" value="<?php (!empty($FIELDS['pager'])) ? val(encode_form_val($FIELDS['pager'])) : ""; ?>" class='form-control fc-fl' id="tfPager" name="tfPager">
            </div>
            <div class="ccm-row">
                <button type="button" class='btn btn-sm btn-info btn-contactgroupBox icon-in-btn' onclick="overlay('contactgroupBox')"><i class="material-symbols-outlined">contacts_product</i> <?php echo _("Manage Contact Groups"); ?> <span class="badge"><?php echo $cgs; ?></span></button>
            </div>
            <div class="ccm-row spacer">
                <button type="button" class='btn btn-sm btn-info btn-contacttemplateBox icon-in-btn' onclick="overlay('contacttemplateBox')"><i class="material-symbols-outlined">contacts</i><?php echo _("Manage Contact Templates"); ?> <span class="badge"><?php echo $cts; ?></span></button>
            </div>
            <?php 
            ...
            ?>
            <div class="ccm-row oneline neptune-spacer">
                <div class="checkbox">
                    <input name="Active" type="checkbox" class="neptune-ccm-checkbox" id="Active" value="1" <?php echo $active_checked; ?>>
                    <label class="neptune-checkbox-label" for="Active">
        ...
        <div class="rightBox">      
            <div class="ccm-row">
                ...
                <input type="text" value="<?php (!empty($FIELDS['address1'])) ? val(encode_form_val($FIELDS['address1'])) : ""; ?>" id="tfAddress1" name="tfAddress1" class='form-control fc-fl'>
            </div>
            <div class="ccm-row">
                <label for="tfAddress2"><?php echo _("Addon Address 2"); ?></label>
                <input type="text" value="<?php (!empty($FIELDS['address2'])) ? val(encode_form_val($FIELDS['address2'])) : ""; ?>" id="tfAddress2" name="tfAddress2" class='form-control fc-fl'>
            </div>
            <div class="ccm-row">
                <label for="tfAddress3"><?php echo _("Addon Address 3"); ?></label>
                <input type="text" value="<?php (!empty($FIELDS['address3'])) ? val(encode_form_val($FIELDS['address3'])) : ""; ?>" id="tfAddress3" name="tfAddress3" class='form-control fc-fl'>
            </div>
            <div class="ccm-row">
                <label for="tfAddress4"><?php echo _("Addon Address 4"); ?></label>
                <input type="text" value="<?php (!empty($FIELDS['address4'])) ? val(encode_form_val($FIELDS['address4'])) : ""; ?>" id="tfAddress4" name="tfAddress4" class='form-control fc-fl'>
            </div>
            <div class="ccm-row">
                <label for="tfAddress5"><?php echo _("Addon Address 5"); ?></label>
                <input type="text" value="<?php (!empty($FIELDS['address5'])) ? val(encode_form_val($FIELDS['address5'])) : ""; ?>" id="tfAddress5" name="tfAddress5" class='form-control fc-fl'>
            </div>
            <div class="ccm-row">
                <label for="tfAddress6"><?php echo _("Addon Address 6"); ?></label>
                <input type="text" value="<?php (!empty($FIELDS['address6'])) ? val(encode_form_val($FIELDS['address6'])) : ""; ?>" id="tfAddress6" name="tfAddress6" class='form-control fc-fl'>
            </div>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <div id="tab2" class="contact-settings">
        <div class="leftBox" style="width: 488px;">
            <div class="ccm-row">
                <label><?php echo _("Host Notifications Enabled"); ?></label>
                <div class="btn-group ccm-btn-group" data-toggle="buttons">
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['host_notifications_enabled']) && $FIELDS['host_notifications_enabled'] == '1') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['host_notifications_enabled']) && $FIELDS['host_notifications_enabled'] == '0') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['host_notifications_enabled']) && $FIELDS['host_notifications_enabled'] == '2') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['host_notifications_enabled']) && $FIELDS['host_notifications_enabled'] == '3') { echo 'active'; } ?>">
            ...
            <div class="ccm-row spacer">
                ...
                <?php $hno = (!empty($FIELDS['host_notification_options'])) ? explode(',', $FIELDS['host_notification_options']) : array(); ?>
                <div class="btn-group ccm-btn-group" data-toggle="buttons">
            ...
            <div class="ccm-row">
                ...
                <div class="btn-group ccm-btn-group" data-toggle="buttons">
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['retain_status_information']) && $FIELDS['retain_status_information'] == '1') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['retain_status_information']) && $FIELDS['retain_status_information'] == '0') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['retain_status_information']) && $FIELDS['retain_status_information'] == '2') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['retain_status_information']) && $FIELDS['retain_status_information'] == '3') { echo 'active'; } ?>">
            ...
            <div class="ccm-row">
                ...
                <div class="btn-group ccm-btn-group" data-toggle="buttons">
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['retain_nonstatus_information']) && $FIELDS['retain_nonstatus_information'] == '1') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['retain_nonstatus_information']) && $FIELDS['retain_nonstatus_information'] == '0') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['retain_nonstatus_information']) && $FIELDS['retain_nonstatus_information'] == '2') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['retain_nonstatus_information']) && $FIELDS['retain_nonstatus_information'] == '3') { echo 'active'; } ?>">
        ...
        <div class="rightBox" style="width: 552px;">
            <div class="ccm-row">
                ...
                <div class="btn-group ccm-btn-group" data-toggle="buttons">
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['service_notifications_enabled']) && $FIELDS['service_notifications_enabled'] == '1') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['service_notifications_enabled']) && $FIELDS['service_notifications_enabled'] == '0') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['service_notifications_enabled']) && $FIELDS['service_notifications_enabled'] == '2') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['service_notifications_enabled']) && $FIELDS['service_notifications_enabled'] == '3') { echo 'active'; } ?>">
            ...
            <div class="ccm-row spacer">
                ...
                <?php $sno = (!empty($FIELDS['service_notification_options'])) ? explode(',', $FIELDS['service_notification_options']) : array(); ?>
                <div class="btn-group ccm-btn-group" data-toggle="buttons">
            ...
            <div class="ccm-row">
                ...
                <div class="btn-group ccm-btn-group" data-toggle="buttons">
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['can_submit_commands']) && $FIELDS['can_submit_commands'] == '1') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['can_submit_commands']) && $FIELDS['can_submit_commands'] == '0') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['can_submit_commands']) && $FIELDS['can_submit_commands'] == '2') { echo 'active'; } ?>">
                    ...
                    <label class="btn btn-xs btn-default <?php if (!empty($FIELDS['can_submit_commands']) && $FIELDS['can_submit_commands'] == '3') { echo 'active'; } ?>">
