...
class DB
{
    ...
    {
        print '<p class="error">Could not complete the query because: <br />'.$this->db->error.'</p>';
    ...
    {   
        ...
        // Service tables append an 'S' to the end of the key, accounting for this
        if (strpos($tbl, "ServicegroupTo") !== false && $key == 'idSlave' && strpos($tbl,"ToServicegroup" ) === false) {
            $key = 'idSlaveS';
        }
