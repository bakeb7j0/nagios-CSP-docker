...
function make_highcharts(data, host, service, track, uid, width, height) {
    ...
    var yAxis = {
        ...
        endOnTick: true,
        gridLineWidth: 1,
        gridLineColor: 'var(--cp-chart-border)'
    };
    ...
    var chart = new Highcharts.Chart({
        ...
        chart: {
            ...
            marginLeft: 75,
            plotBorderWidth: 1,
            plotBorderColor: 'var(--cp-chart-border)',
            resetZoomButton: {
                position: {
                    x: -29,
                    y: -50
        ...
        xAxis: {
            ...
            lineColor: 'var(--cp-chart-border)',
            tickColor: 'var(--cp-chart-border)',
        },
        yAxis: yAxis,
        tooltip: {
            enabled: tracking,
        ...
        legend: {
            enabled: true,
            backgroundColor: 'var(--cp-chart-background)'
        },
        plotOptions: {
            series: {
                fillOpacity: 0.5,
