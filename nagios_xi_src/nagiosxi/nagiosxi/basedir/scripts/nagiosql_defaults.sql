...
CREATE TABLE `tbl_domain` (
  ...
  `mrtgconfig` varchar(255) NOT NULL default '/etc/mrtg/conf.d/',
...
INSERT INTO `tbl_domain` VALUES (1,'localhost','Local installation','localhost','1','','','/usr/local/nagios/etc/','/usr/local/nagios/etc/hosts/','/usr/local/nagios/etc/services/','/etc/mrtg/conf.d/','/etc/nagiosql/backup/','/etc/nagiosql/backup/hosts/','/etc/nagiosql/backup/services/','/usr/local/nagios/etc/','/usr/local/nagios/etc/import/','/var/nagios/rw/nagios.cmd','/usr/local/nagios/bin/nagios','/var/nagios/nagios.lock',3,'00000000','1','1','2009-10-08 17:27:46');
